...
class SolidSplash {
	...
	public $solid_post_type 					= 'solid_page';
	...
	function wp_admin_enqueue_scripts() {
        ...
        wp_enqueue_style( 'select2', esc_url( $this->plugin_dir( 'inc/select2/select2.min.css' ) ) );

        wp_dequeue_script( 'select2' );
        wp_deregister_script( 'select2' );
		wp_enqueue_script( 'select2', esc_url( $this->plugin_dir( 'inc/select2/select2.min.js' ) ), array( 'jquery' ), false, true );
	}
